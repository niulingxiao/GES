...
def get_opt():
    ...
    parser.add_argument("--test_file", type=str, default="/path/to/folder/", help="Path to the image list")
    parser.add_argument("--save_dir", type=str, default="./output_pred")
